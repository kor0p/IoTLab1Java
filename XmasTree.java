...
public class XmasTree {
	...
	private int radius = 0; // radius of basis
	...
	public XmasTree (
			String name, int height, int price, String material,
	...
	public String toString()
	{
		return    " name: "+name+
			...
			"\n radius: "+radius+"cm"+
			"\n country: "+country+
			"\n num of branches: "+numberOfBranches+
			"\n was used: "+wasUsed+
			"\n";
	}
	...
	public static void main(String[] args)
	{
		...
		XmasTree tree2 = new XmasTree(
				"Christmas feast", 150, 200,"plastic");
		XmasTree tree3 = new XmasTree(
				"XmasHen", 300, 400, "plastic+metal",
				100, "Ukraine", 100, true);
